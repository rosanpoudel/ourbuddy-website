          ...
          <div className="col-span-4 flex flex-col justify-center item-center">
            <>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="text-[18px] text-gray-600 text-center font-bold mt-3 mb-2">
                  Company Information
                </div>
                <div className="text-[16px] text-center text-[#293c67]">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="text-[16px] text-center text-[#868C97]">
